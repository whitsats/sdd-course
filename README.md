...
六个阶段、15 节课（含两节可选进阶），每节 **1–2 小时**，每节都有可提交的产出物。

> ⏱️ **时间预算分两层，别用错**：跟着教程走一遍约 **28 小时**；
> 五个项目都能端到端演示约 **58 小时**——差出来的 30 小时全在写代码、跑测试、跟 CI 打架上，**而那才是真正的价值所在**。
...
.
├── README.md              ← 你在这里（课程主页）
├── PLAN.md                ← 详细学习计划：15 节全展开
├── lessons/               ← 教程正文，15 节全部就绪（15 个文件 / 6300+ 行）
